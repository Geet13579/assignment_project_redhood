        ...
        >
          <div className={cn("w-full items-center flex justify-between ",
            ...
            <div className="flex items-center" >
              ...
              <p
                className={cn(
                  "max-w-[150px] truncate text-left",
              ...
              >
                {label}
                <p className="font-regular  text-[12px] mt-2 text-left text-[#827979]">{index == 0 ? Profile.designation == null ? Profile?.user_type :  Profile.designation : ""}</p>
