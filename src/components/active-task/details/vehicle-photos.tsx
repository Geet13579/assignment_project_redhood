...
const DetailsPage = ({ tasks }: DetailsPageProps) => {
  const [selectedServiceCenter, setSelectedServiceCenter] = useState(
    tasks.type === "PICKUP" ? "Pick-up photo" : "Service Center to Drop-off"
  );
  ...
  selectedServiceCenter === "Pick-up photo"
    ? tasks.pick_up_images
    : selectedServiceCenter === "Return to Service photos"
    ? tasks.return_images
    :  selectedServiceCenter === "At Service Center Photo" ? tasks.drop_off_images:""
